...
def sidebar():
    ...
    with st.sidebar:
        documents_uploads = st.file_uploader("Upload documents", accept_multiple_files=True,
                                             help="Supported formats: pdf, docx, doc, txt, ppt, csv, html, xls")
        ...
        documents_uploads_url = st.text_input("Upload documents via url",
                                              help="Supported formats: pdf, docx, doc, txt, ppt, csv, html, xls")
